...
const dateToTry8 = new Date('2022-05-23T01:02:45.000Z');
const dateToTry9 = new Date('2025-01-11T15:02:45.000Z');

console.log(timePassed(new Date()));
console.log(timePassed(dateToTry8));
console.log(timePassed(dateToTry9));
console.log(timePassed(dateToTry8, { days: false, hours: false }));
